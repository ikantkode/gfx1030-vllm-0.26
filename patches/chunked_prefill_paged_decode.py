...
def chunked_prefill_paged_decode(
    ...
    if use_custom:
        ...
        kernel_paged_attention_2d[
            ...
            # gfx1030 patch (rung 14): grid is (num_seqs, num_kv_heads) = 4
            # workgroups on 72 CUs; default 4 warps leaves the kernel
            # latency-bound on the serialized block-table gather loop.
            # 8 warps halves decode-attention kernel time (226->112 us at
            # seq 281), output within fp16 reduction-order noise.
            num_warps=8,
        )
